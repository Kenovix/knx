...
class CargoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
        	...
        	->add('tipoCargo', 'choice', array('label' => 'Tipo de cargo:', 'empty_value' => 'Seleccione una opción', 'choices' => array('CE' => 'Consulta', 'CU' => 'Consulta urgencias', 'P' => 'Procedimiento', 'LB' => 'Laboratorio', 'OS' => 'Otros Servicios')));
    }
